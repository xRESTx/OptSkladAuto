...
// Открываем диалоговое окно для редактирования этого платежа
    ...
    private void loadPayments() {
        ...
        // Загружаем все платежи, фильтруем их по логину пользователя через заказ
        List<Payment> userPayments = PaymentDAO.findPaymentsByUserLogin(currentLogin);

        // Обновляем таблицу с отфильтрованными платежами
        updatePaymentTable(userPayments);
    }
